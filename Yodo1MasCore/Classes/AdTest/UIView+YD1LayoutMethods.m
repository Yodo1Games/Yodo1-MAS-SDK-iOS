...
static void *kYD1UIViewLayoutMethodPropertyTopGap = &kYD1UIViewLayoutMethodPropertyTopGap;
...
- (void)fromTheRelativeTop:(CGFloat)distance ofView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
    [self bottomRatio:distance FromView:view screenType:screenType];
}

- (void)fromTheRelativeBottom:(CGFloat)distance ofView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
    [self topRatio:distance FromView:view screenType:screenType];
}

- (void)fromTheRelativeLeft:(CGFloat)distance ofView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
    [self leftRatio:distance FromView:view screenType:screenType];
}

- (void)fromTheRelativeRight:(CGFloat)distance ofView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
    [self rightRatio:distance FromView:view screenType:screenType];
}


- (void)relativeTopInContainer:(CGFloat)top shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    [self topRatioInContainer:top shouldResize:shouldResize screenType:screenType];
}

- (void)relativeBottomInContainer:(CGFloat)bottom shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    [self bottomRatioInContainer:bottom shouldResize:shouldResize screenType:screenType];
}

- (void)relativeLeftInContainer:(CGFloat)left shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    [self leftRatioInContainer:left shouldResize:shouldResize screenType:screenType];
}

- (void)relativeRightInContainer:(CGFloat)right shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
...
- (void)topRatio:(CGFloat)top FromView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
...
- (void)bottomRatio:(CGFloat)bottom FromView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
...
- (void)leftRatio:(CGFloat)left FromView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
...
- (void)rightRatio:(CGFloat)right FromView:(UIView *)view screenType:(YD1UIScreenType)screenType
{
...
- (void)topRatioInContainer:(CGFloat)top shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    CGFloat topRatio = top / screenType;
    CGFloat topValue = topRatio * self.superview.ct_width;
...
- (void)bottomRatioInContainer:(CGFloat)bottom shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    CGFloat bottomRatio = bottom / screenType;
    CGFloat bottomValue = bottomRatio * self.superview.ct_width;
...
- (void)leftRatioInContainer:(CGFloat)left shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    CGFloat leftRatio = left / screenType;
    CGFloat leftValue = leftRatio * self.superview.ct_width;
...
- (void)rightRatioInContainer:(CGFloat)right shouldResize:(BOOL)shouldResize screenType:(YD1UIScreenType)screenType
{
    CGFloat rightRatio = right / screenType;
    CGFloat rightValue = rightRatio * self.superview.ct_width;
...
{
    NSNumber *gap = objc_getAssociatedObject(self, kYD1UIViewLayoutMethodPropertyBottomGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, kYD1UIViewLayoutMethodPropertyBottomGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
...
{
    NSNumber *gap = objc_getAssociatedObject(self, kYD1UIViewLayoutMethodPropertyTopGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, kYD1UIViewLayoutMethodPropertyTopGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
...
{
    NSNumber *gap = objc_getAssociatedObject(self, kYD1UIViewLayoutMethodPropertyLeftGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
        ...
        objc_setAssociatedObject(self, kYD1UIViewLayoutMethodPropertyLeftGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
...
{
    NSNumber *gap = objc_getAssociatedObject(self, kYD1UIViewLayoutMethodPropertyRightGap);
    if (gap == nil) {
        if (@available(iOS 11, *)) {
            gap = @(self.superview.safeAreaLayoutGuide.layoutFrame.origin.x);
        } else {
        ...
        objc_setAssociatedObject(self, kYD1UIViewLayoutMethodPropertyRightGap, gap, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    return gap.floatValue;
}
