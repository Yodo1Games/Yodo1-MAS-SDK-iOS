...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Yodo1/Yodo1MasMediationAdMob'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ZhouYuzhen' => 'zhouyuzhen@yodo1.com' }
  s.source           = { :git => 'https://github.com/Yodo1/Yodo1MasMediationAdMob.git', :tag => s.version.to_s }
  ...
  s.dependency 'GoogleMobileAdsMediationAppLovin'#, '6.14.8.0'
  ...
  s.dependency 'GoogleMobileAdsMediationUnity'#,'2.1.2.0'
